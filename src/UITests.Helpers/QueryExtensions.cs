...
namespace UITests.Helpers
{
	public static partial class QueryExtensions
	{
		...
		/// <summary>
		/// Apply a transform (that processes <see cref="AppQuery"/> elements) to the current query's inner definition
		/// </summary>
		/// <param name="query">The current query</param>
		/// <param name="transform">The transform that will be applied to the current query's inner definition</param>
		/// <returns>A new query that incorporated the changes applied by the given transform</returns>
		public static QueryEx RawTransform(this QueryEx query, Func<AppQuery, AppQuery> transform)
		{
		...
		public static AppResult[] Results(this QueryEx query)
		{
		...
		public static AppResult FirstResult(this QueryEx query)
		{
		...
		{
			UITests.Queries.Helpers.Step(title);
			return query;
		}
	}
}