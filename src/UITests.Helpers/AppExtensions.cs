...
using static UITests.Helpers.Configuration;
...
namespace UITests.Helpers
{
	public static partial class AppExtensions
	{
		...
		public static AppRect GetScreenDimensions(this IApp app)
		{
		...
		public static T Wait<T>(this T app, TimeSpan waitTime) where T : IApp
		{
			...
			UITests.Queries.Helpers.Wait(waitTime);
			return app;
		}
		...
		public static T Wait<T>(this T app, int seconds) where T : IApp
		{
			...
			UITests.Queries.Helpers.Wait(seconds);
			return app;
		}
