...
namespace UITests.Helpers
{
	public static partial class QueryExExtensions
	{
		...
		/// <returns>The filtered query</returns>
		public static QueryEx Filter(this QueryEx query, string propertyName, Func<PropertyAppQuery, AppQuery> filterPredicate)
		{
		...
		/// <param name="filterPredicate">The filter to apply to the current query</param>
		/// <returns>The filtered query</returns>
		public static QueryEx Filter(this QueryEx query, Func<PropertyAppQuery, AppQuery> filterPredicate)
		{
